export default {
  ...
  proxy: {
    ...
    confirmSwitch: '确认切换',
    testProgress: '测试进度:',
    groupTestComplete: '组测速完成',
    testFailed: '测速失败',
    batchTestComplete: '批量测速完成',
    loadSuccess: '代理列表加载成功',
    loadFailed: '获取代理列表失败',
    loadFailedCheck: '获取代理列表失败，请检查Sing-Box是否已启动',
    testErrorMessage: '测速失败，可能是节点无法连接或API未响应',
  ...
  sub: {
    ...
    deleteFailed: '删除订阅失败',
    invalidUrl: '无效的订阅地址',
    duplicateName: '订阅名称已存在',
    duplicateUrl: '订阅地址已存在',
    convertSuccess: '转换成功',
    convertFailed: '转换失败',
    importSuccess: '导入成功',
    importFailed: '导入失败',
    ...
    configContentPlaceholder: '配置内容（JSON格式）',
    saveAndApply: '保存并应用',
    nameRequired: '请输入订阅名称',
    urlRequired: '请输入订阅链接',
    contentRequired: '请输入配置内容',
    operationFailed: '操作失败：',
    cannotDeleteActive: '不能删除当前正在使用的订阅',
    useSuccess: '订阅使用成功',
    useFailed: '订阅使用失败：',
