export default {
  ...
  templateMarket: {
    title: '模板市场',
    subtitle: '管理本地配置模板，发现并使用社区分享的在线模板',
    tabCurrent: '当前模板',
    tabMarket: '模板市场',
    tabMine: '我的发布',
    ...
    serviceUrlHint: '清空并保存可恢复为内置默认服务地址（开发构建为本地调试地址）',
    testConnection: '测试连接',
    testOk: '连接成功（服务版本 v{version}）',
    serviceNotConfigured: '未配置模板市场服务',
    serviceNotConfiguredDesc: '配置你自部署的模板市场服务地址后，即可浏览和下载在线模板',
    configureService: '配置服务地址',
    officialName: '官方默认模板',
    officialActiveHint: '当前使用官方默认模板：订阅下载/刷新将使用内置通用骨架',
    templateActiveHint: '当前使用模板：',
    sourceBuiltin: '内置',
    sourceLocal: '本地',
    sourceMarket: '来自市场',
    active: '使用中',
    inUse: '使用中',
    activate: '启用此模板',
    activatedToast: '已启用模板「{name}」',
    activateEffectHint: '订阅下次下载或刷新时将使用新模板生成配置',
    newTemplate: '新建模板',
    editTemplate: '编辑模板',
    exportOfficial: '从官方模板导出',
    name: '名称',
    description: '描述',
    author: '作者署名',
    authorPlaceholder: '可选，展示在市场列表中',
    schemaVersion: '内核版本',
    content: '模板内容（sing-box JSON，支持节点占位符）',
    contentPlaceholder:
      '粘贴完整的 sing-box 配置 JSON；outbounds 中可用 {marker} 字符串标记订阅节点注入位置',
    contentInvalid: '模板内容不是合法 JSON',
    contentMustBeObject: '模板内容必须是 JSON 对象',
    contentNeedsOutbounds: '模板必须包含非空的 outbounds 数组',
    ...
    deleteConfirmBody: '确定删除模板「{name}」吗？该操作不可恢复。',
    edit: '编辑',
    delete: '删除',
    publish: '发布',
    publishToMarket: '发布到模板市场',
    publishWarning:
      '模板将以匿名方式发布，管理员审核通过后上架。编辑令牌会自动保存在本设备——换设备后将无法管理该模板。请确保模板内容不含个人服务器信息。',
    publishedToast: '已提交发布，等待管理员审核',
    noDescription: '暂无描述',
    builtin: '内置',
    marketSearch: '搜索模板名称/描述/作者',
    marketSortNewest: '最新发布',
    marketSortDownloads: '下载最多',
    refresh: '刷新',
    detail: '详情',
    downloadUse: '下载使用',
    downloadedToast: '已下载模板「{name}」，可在"当前模板"中启用',
    anonymous: '匿名',
    downloadsUnit: '次下载',
    marketEmpty: '暂无上架模板',
    mineEmpty: '还没有发布过模板',
    mineEmptyDesc: '在"当前模板"中选择本地模板并发布，即可在这里管理审核状态',
    marketStatusPending: '待审核',
    marketStatusApproved: '已上架',
    marketStatusRejected: '已拒绝',
    marketStatusDeleted: '已下架',
    refreshStatus: '刷新审核状态',
    statusRefreshed: '审核状态已更新',
    updatePublish: '更新发布',
    resubmittedToast: '已提交更新，重新进入待审核',
    deleteFromMarket: '下架删除',
    deleteFromMarketTitle: '删除市场记录',
    deleteFromMarketBody: '将从市场删除「{name}」，本地模板会保留。确定继续吗？',
    removedFromMarketToast: '已从市场删除',
    rejectReason: '拒绝理由',
    tokenHint: '编辑令牌仅保存在本设备；清除应用数据或更换设备后将无法再管理已发布的模板。',
    settingsSaved: '服务设置已保存',
    willUseTemplate: '将使用模板',
    modeVisual: '可视化配置',
    modeJson: 'JSON 模式',
    visualUnsupported: '该模板包含表单不支持的结构，仅可使用 JSON 模式编辑',
    defaultOutbound: '默认出站（非国内流量）',
    urltestUrl: '测速地址',
    followAppSetting: '留空则跟随应用设置',
    sectionGroups: '业务分流组（启用后该组域名走对应选择器，可在代理页切换节点）',
    sectionDns: 'DNS 与拦截',
    sectionRules: '自定义分流规则',
    blockAds: '广告拦截',
    dnsHijack: 'DNS 劫持',
    dnsMdns: 'mDNS 本地解析',
    fakeDns: 'Fake DNS',
    dnsProxy: '代理 DNS（DoH）',
    dnsCn: '国内 DNS',
    dnsResolver: '默认 DNS 解析',
    addRule: '添加规则',
    rulePayloadHint: '匹配内容，多个用逗号分隔',
    rulePriorityHint:
      '自定义规则优先于内置国内直连分流。示例：域名后缀 example.com、IP 段 10.0.0.0/8',
  },
  status: {
    running: '运行中',
    starting: '启动中',
  ...
  notification: {
    ...
    kernelErrors: {
      KERNEL_CONFIG_INVALID: '内核配置无效，请检查配置后重试',
      KERNEL_BINARY_MISSING: '未检测到内核文件，请先安装内核',
      KERNEL_START_UNSTABLE: '内核启动后快速退出，请检查配置或端口占用',
      KERNEL_GUARD_RESTART_FAILED: '内核异常停止且自动重启失败',
      KERNEL_GUARD_SELF_HEAL_FAILED: '内核自愈重启失败',
      KERNEL_STOP_FAILED: '内核停止失败',
      KERNEL_AUTO_MANAGE_FAILED: '内核自动管理失败',
      KERNEL_CONFLICT_DETECTED: '检测到旧内核正在运行，正在尝试强制停止后继续',
      KERNEL_CONFLICT_FORCE_STOP_FAILED: '旧内核进程强制停止失败，请手动结束进程后重试',
      KERNEL_RUNTIME_ERROR: '内核运行异常',
      KERNEL_OPERATION_FAILED: '内核操作失败：{operation}',
      details: '详情：{details}',
    },
  },
}
