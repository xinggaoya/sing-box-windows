export default {
  ...
  service: {
    install: {
      title: '服务安装',
      description: 'Sing-Box 需要安装必要的系统服务才能继续使用。此操作需要管理员权限。',
      notAdmin: '当前应用未以管理员身份运行，无法安装服务',
      ...
      startupType: '启动类型',
      servicePath: '服务路径',
      serviceDescription: '提供Sing-Box代理内核的高权限运行环境，支持TUN模式和系统代理设置',
      requiredWarning: '您必须安装服务才能使用 Sing-Box 的全部功能，特别是TUN模式',
      installButton: '安装服务',
      uninstallButton: '卸载服务',
      continueButton: '继续使用',
      refreshSuccess: '服务状态刷新成功',
      refreshError: '刷新服务状态失败: {error}',
      restartError: '以管理员身份重启失败: {error}',
      installSuccess: '服务安装成功！现在您可以使用TUN模式和更多高级功能',
      installError: '服务安装失败: {error}',
      uninstallSuccess: '服务卸载成功',
      uninstallError: '服务卸载失败: {error}',
      uninstallConfirmTitle: '卸载服务',
      uninstallConfirmContent: '确定要卸载系统服务吗？卸载后将无法使用TUN模式等高级功能。',
      uninstallConfirmButton: '确定卸载',
      cancelButton: '取消',
    },
  },
  rules: {
