export default {
  ...
  home: {
    ...
    escalatePrivileges: '提权',
    proxyModeSelector: '代理模式',
    nodeModeSelector: '节点模式',
    trafficMonitor: '流量监控',
    traffic: {
      uploadSpeed: '上传速度',
      downloadSpeed: '下载速度',
  ...
  rules: {
    ...
    fetchTimeout: '获取规则超时，请检查内核是否正常运行',
    totalRules: '总规则数',
    matchingRules: '匹配规则数',
  ...
  notification: {
    ...
    kernelProcessRunning: '内核进程已在运行，但可能需要重新连接',
  },
}
