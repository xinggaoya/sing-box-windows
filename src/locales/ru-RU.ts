export default {
  ...
  home: {
    ...
    // 状态信息
    startSuccess: 'Запуск выполнен успешно',
    startFailed: 'Ошибка запуска',
    stopSuccess: 'Остановка выполнена успешно',
    ...
    proxyMode: {
      ...
      tunTip: 'Использование TUN виртуальной сетевой карты для проксирования всего трафика, требуются права администратора',
      manualTip: 'Требуется ручная настройка системного прокси',
      systemDescription: 'Автоматическая настройка системного прокси для браузеров и приложений',
      ...
      manualDescription: 'Требуется ручная настройка прокси в приложениях и браузерах',
    },
    ...
    nodeMode: {
      ...
      ruleTip: 'Интеллектуальное разделение трафика по правилам',
    },
  ...
  setting: {
    ...
    autoStart: {
      ...
      kernel: 'Запуск ядра',
      kernelDesc: 'Автоматический запуск сервиса ядра при запуске приложения',
    },
