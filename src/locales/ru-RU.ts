export default {
  ...
  noIssues: "No issues",
    ...
    sudoPassword: {
      ...
      description:
        'Первое включение TUN требует sudo-привилегий для запуска ядра. Пароль будет безопасно сохранён в системном хранилище (Keychain/Keyring) и никогда не будет отправлен в сеть.',
