export default {
  ...
  setting: {
    ...
    kernel: {
      ...
      latest: 'Последняя',
      versionLocked:
        'Приложение ориентировано на новейшее ядро: версия следует за выпусками приложения. Ручное переключение отключено, загрузка всегда использует последнюю версию.',
    },
    proxyAdvanced: {
