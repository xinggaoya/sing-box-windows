export default {
  ...
  templateMarket: {
    ...
    subtitle: 'Manage local config templates and discover community shared templates',
    tabCurrent: 'Current Templates',
    tabMarket: 'Market',
    tabMine: 'My Publications',
    serviceSettings: 'Service Settings',
    serviceUrl: 'Service URL',
    serviceUrlPlaceholder: 'https://templates.example.com',
    serviceUrlHint:
      'Clear and save to restore the built-in default service address (local debug address in dev builds)',
    testConnection: 'Test Connection',
    testOk: 'Connected (service v{version})',
    serviceNotConfigured: 'Template market service not configured',
    serviceNotConfiguredDesc:
      'Set your self-hosted template market URL to browse and download online templates',
    configureService: 'Configure Service URL',
    officialName: 'Official Default Template',
    officialActiveHint:
      'Using the official default template: subscription downloads/refreshes use the built-in general skeleton',
    templateActiveHint: 'Current template: ',
    sourceBuiltin: 'Built-in',
    sourceLocal: 'Local',
    sourceMarket: 'From Market',
    active: 'In Use',
    inUse: 'In Use',
    activate: 'Activate',
    activatedToast: "Template '{name}' activated",
    activateEffectHint: 'New template takes effect on next subscription download or refresh',
    newTemplate: 'New Template',
    editTemplate: 'Edit Template',
    exportOfficial: 'Export from Official Template',
    name: 'Name',
    description: 'Description',
    author: 'Author',
    authorPlaceholder: 'Optional, shown in the market list',
    schemaVersion: 'Kernel Version',
    content: 'Template Content (sing-box JSON with node placeholder)',
    contentPlaceholder:
      'Paste a full sing-box config JSON; put the {marker} string inside outbounds to mark where subscription nodes are injected',
    contentInvalid: 'Template content is not valid JSON',
    contentMustBeObject: 'Template content must be a JSON object',
    contentNeedsOutbounds: 'Template must contain a non-empty outbounds array',
    ...
    deleteConfirmBody: "Delete template '{name}'? This cannot be undone.",
    edit: 'Edit',
    delete: 'Delete',
    publish: 'Publish',
    publishToMarket: 'Publish to Market',
    publishWarning:
      'Templates are published anonymously and listed after admin review. The edit token is stored only on this device - you cannot manage the template from another device. Make sure the content contains no personal server info.',
    publishedToast: 'Submitted for review',
    noDescription: 'No description',
    builtin: 'Built-in',
    marketSearch: 'Search templates by name/description/author',
    marketSortNewest: 'Newest',
    marketSortDownloads: 'Most Downloaded',
    refresh: 'Refresh',
    detail: 'Details',
    downloadUse: 'Download & Use',
    downloadedToast: "Downloaded '{name}'. Activate it under 'Current Templates'.",
    anonymous: 'Anonymous',
    downloadsUnit: 'downloads',
    marketEmpty: 'No templates listed yet',
    mineEmpty: 'No publications yet',
    mineEmptyDesc:
      'Publish a local template from the Current Templates tab to manage its review status here',
    marketStatusPending: 'Pending Review',
    marketStatusApproved: 'Listed',
    marketStatusRejected: 'Rejected',
    marketStatusDeleted: 'Removed',
    refreshStatus: 'Refresh Status',
    statusRefreshed: 'Review status updated',
    updatePublish: 'Push Update',
    resubmittedToast: 'Update submitted, back to review',
    deleteFromMarket: 'Remove',
    deleteFromMarketTitle: 'Remove from Market',
    deleteFromMarketBody: "Remove '{name}' from the market? The local template will be kept.",
    removedFromMarketToast: 'Removed from market',
    rejectReason: 'Reason',
    tokenHint:
      'The edit token is stored only on this device; clearing app data or switching devices means you can no longer manage published templates.',
    settingsSaved: 'Service settings saved',
    willUseTemplate: 'Template to use',
    modeVisual: 'Visual Editor',
    modeJson: 'JSON Mode',
    visualUnsupported:
      'This template contains structures not supported by the visual editor; JSON mode only',
    defaultOutbound: 'Default Outbound (non-CN traffic)',
    urltestUrl: 'URL Test Address',
    followAppSetting: 'Leave empty to follow app settings',
    sectionGroups: 'Service Groups (enabled groups route matching sites to their selector)',
    sectionDns: 'DNS & Blocking',
    sectionRules: 'Custom Routing Rules',
    blockAds: 'Ad Blocking',
    dnsHijack: 'DNS Hijack',
    dnsMdns: 'mDNS Local Resolution',
    fakeDns: 'Fake DNS',
    dnsProxy: 'Proxy DNS (DoH)',
    dnsCn: 'CN DNS',
    dnsResolver: 'Default DNS Resolver',
    addRule: 'Add Rule',
    rulePayloadHint: 'Match values, comma separated',
    rulePriorityHint:
      'Custom rules take priority over built-in CN direct rules. e.g. domain suffix example.com, IP range 10.0.0.0/8',
  },
  status: {
    running: 'Running',
    starting: 'Starting',
