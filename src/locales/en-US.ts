export default {
  ...
  service: {
    install: {
      ...
      description: 'Sing-Box needs to install necessary system service to continue. This operation requires administrator privileges.',
      notAdmin: 'The application is not running as administrator, cannot install service',
      restartAsAdmin: 'Restart as Admin',
      serviceStatus: 'Service Installation Status',
      runningStatus: 'Service Running Status',
      adminStatus: 'Admin Privileges',
      installed: 'Installed',
      ...
      serviceDescription: 'Provides high-privilege environment for Sing-Box proxy kernel, supports TUN mode and system proxy settings',
      requiredWarning: 'You must install the service to use all features of Sing-Box, especially TUN mode',
      ...
      uninstallConfirmTitle: 'Uninstall Service',
      uninstallConfirmContent: 'Are you sure you want to uninstall the system service? You will not be able to use TUN mode and other advanced features after uninstallation.',
