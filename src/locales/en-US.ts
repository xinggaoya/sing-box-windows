export default {
  ...
  proxy: {
    ...
    groupTestComplete: 'Group speed test completed',
    testFailed: 'Speed test failed',
    batchTestComplete: 'Batch speed test completed',
    ...
    testErrorMessage: 'Speed test failed, the node may be unreachable or API is not responding',
  ...
  sub: {
    ...
    invalidUrl: 'Invalid subscription URL',
    duplicateName: 'Subscription name already exists',
    duplicateUrl: 'Subscription URL already exists',
    ...
    editConfig: 'Edit Current Config',
    ...
    cannotDeleteActive: 'Cannot delete currently active subscription',
    useSuccess: 'Subscription applied successfully',
    useFailed: 'Failed to apply subscription: ',
