export default {
  ...
  templateMarket: {
    title: 'テンプレートマーケット',
    subtitle: 'ローカル設定テンプレートを管理し、コミュニティのテンプレートを利用',
    tabCurrent: '現在のテンプレート',
    tabMarket: 'マーケット',
    tabMine: '公開中のテンプレート',
    serviceSettings: 'サービス設定',
    serviceUrl: 'サービスアドレス',
    serviceUrlPlaceholder: 'https://templates.example.com',
    serviceUrlHint: '空にして保存すると内蔵のデフォルトアドレスに戻ります',
    testConnection: '接続テスト',
    testOk: '接続成功（サービス v{version}）',
    serviceNotConfigured: 'テンプレートサービス未設定',
    serviceNotConfiguredDesc:
      '自前でデプロイしたマーケットのアドレスを設定すると、オンラインテンプレートを閲覧・ダウンロードできます',
    configureService: 'サービスアドレスを設定',
    officialName: '公式デフォルトテンプレート',
    officialActiveHint:
      '公式テンプレート使用中：サブスクリプションの取得・更新は内蔵スケルトンを使用します',
    templateActiveHint: '使用中のテンプレート：',
    sourceBuiltin: '内蔵',
    sourceLocal: 'ローカル',
    sourceMarket: 'マーケットから',
    active: '使用中',
    inUse: '使用中',
    activate: '適用',
    activatedToast: 'テンプレート「{name}」を適用しました',
    activateEffectHint: '次回のサブスクリプション取得・更新時から新しいテンプレートが使われます',
    newTemplate: '新規テンプレート',
    editTemplate: 'テンプレート編集',
    exportOfficial: '公式テンプレートから生成',
    name: '名称',
    description: '説明',
    author: '作者名',
    authorPlaceholder: '任意。マーケットの一覧に表示されます',
    schemaVersion: 'カーネルバージョン',
    content: 'テンプレート内容（sing-box JSON、ノードプレースホルダ対応）',
    contentPlaceholder:
      '完全な sing-box 設定 JSON を貼り付け。outbounds 内の {marker} 文字列がノード挿入位置の目印になります',
    contentInvalid: 'テンプレート内容が正しい JSON ではありません',
    contentMustBeObject: 'テンプレート内容は JSON オブジェクトである必要があります',
    contentNeedsOutbounds: '空でない outbounds 配列が必要です',
    ...
    deleteConfirmBody: 'テンプレート「{name}」を削除しますか？元に戻せません。',
    edit: '編集',
    delete: '削除',
    publish: '公開',
    publishToMarket: 'マーケットへ公開',
    publishWarning:
      'テンプレートは匿名で公開され、管理者の承認後に掲載されます。編集トークンはこの端末のみに保存されます。個人情報やサーバー情報が含まれていないことを確認してください。',
    publishedToast: '公開申請を送信しました。承認をお待ちください',
    noDescription: '説明なし',
    builtin: '内蔵',
    marketSearch: '名前/説明/作者で検索',
    marketSortNewest: '新着順',
    marketSortDownloads: 'ダウンロード順',
    refresh: '更新',
    detail: '詳細',
    downloadUse: 'ダウンロードして使用',
    downloadedToast: '「{name}」をダウンロードしました。「現在のテンプレート」から適用できます',
    anonymous: '匿名',
    downloadsUnit: 'ダウンロード',
    marketEmpty: '掲載中のテンプレートはありません',
    mineEmpty: '公開中のテンプレートはありません',
    mineEmptyDesc:
      '「現在のテンプレート」タブからローカルテンプレートを公開すると、ここで審査状況を管理できます',
    marketStatusPending: '審査中',
    marketStatusApproved: '掲載中',
    marketStatusRejected: '却下',
    marketStatusDeleted: '取り下げ',
    refreshStatus: '審査状況を更新',
    statusRefreshed: '審査状況を更新しました',
    updatePublish: '更新を送信',
    resubmittedToast: '更新を送信しました。審査待ちです',
    deleteFromMarket: '取り下げ',
    deleteFromMarketTitle: 'マーケットから削除',
    deleteFromMarketBody:
      '「{name}」をマーケットから削除しますか？ローカルのテンプレートは残ります。',
    removedFromMarketToast: 'マーケットから削除しました',
    rejectReason: '却下理由',
    tokenHint:
      '編集トークンはこの端末にのみ保存されます。データ消去や機種変更後は公開済みテンプレートを管理できません。',
    settingsSaved: 'サービス設定を保存しました',
    willUseTemplate: '使用テンプレート',
    modeVisual: 'ビジュアル設定',
    modeJson: 'JSON モード',
    visualUnsupported:
      'このテンプレートにはビジュアルエディタが対応していない構造があるため、JSON モードのみ編集できます',
    defaultOutbound: 'デフォルト送信先（海外トラフィック）',
    urltestUrl: '速度テスト URL',
    followAppSetting: '空欄でアプリ設定に従う',
    sectionGroups: 'サービス分组（有効化した分组のサイトは対応セレクターへ）',
    sectionDns: 'DNS とブロック',
    sectionRules: 'カスタムルーティングルール',
    blockAds: '広告ブロック',
    dnsHijack: 'DNS ハイジャック',
    dnsMdns: 'mDNS ローカル解決',
    fakeDns: 'Fake DNS',
    dnsProxy: 'プロキシ DNS (DoH)',
    dnsCn: '中国 DNS',
    dnsResolver: 'デフォルト DNS リゾルバ',
    addRule: 'ルールを追加',
    rulePayloadHint: '一致内容、カンマ区切り',
    rulePriorityHint:
      'カスタムルールは内蔵の中国ダイレクトより優先されます。例: ドメイン接尾辞 example.com、IP 範囲 10.0.0.0/8',
  },
  ...
  upgradeNotices: {
    ...
    deprecatedBody:
      '以下の設定フィールドは sing-box で非推奨となり、1.16 で削除されます。早めに調整してください：',
  },
  notification: {
    ...
    kernelErrors: {
      KERNEL_CONFIG_INVALID: 'カーネル設定が無効です。設定を確認して再試行してください。',
      KERNEL_BINARY_MISSING:
        'カーネルファイルが見つかりません。先にカーネルをインストールしてください。',
      KERNEL_START_UNSTABLE:
        'カーネルが起動直後に終了しました。設定やポートの使用状況を確認してください。',
      KERNEL_GUARD_RESTART_FAILED: 'カーネルが異常停止し、自動再起動に失敗しました。',
      KERNEL_GUARD_SELF_HEAL_FAILED: 'カーネルの自己修復での再起動に失敗しました。',
      KERNEL_STOP_FAILED: 'カーネルの停止に失敗しました。',
      KERNEL_AUTO_MANAGE_FAILED: 'カーネルの自動管理に失敗しました。',
      KERNEL_CONFLICT_DETECTED: '旧カーネルが実行中です。強制停止してから再試行しています。',
      KERNEL_CONFLICT_FORCE_STOP_FAILED:
        '旧カーネルプロセスの強制停止に失敗しました。手動でプロセスを終了して再試行してください。',
      KERNEL_RUNTIME_ERROR: 'カーネル実行エラー',
      KERNEL_OPERATION_FAILED: 'カーネル操作に失敗しました：{operation}',
      details: '詳細：{details}',
    },
  },
}
