export default {
  ...
  service: {
    install: {
      title: 'サービスインストール',
      description: 'Sing-Boxを続けて使用するには、必要なシステムサービスをインストールする必要があります。この操作には管理者権限が必要です。',
      notAdmin: 'アプリケーションが管理者として実行されていないため、サービスをインストールできません',
      restartAsAdmin: '管理者として再起動',
      ...
      startupType: '起動タイプ',
      servicePath: 'サービスパス',
      serviceDescription: 'Sing-Boxプロキシカーネルの高権限実行環境を提供し、TUNモードとシステムプロキシ設定をサポートします',
      requiredWarning: 'Sing-Boxのすべての機能、特にTUNモードを使用するにはサービスをインストールする必要があります',
      ...
      uninstallConfirmTitle: 'サービスアンインストール',
      uninstallConfirmContent: 'システムサービスをアンインストールしてもよろしいですか？アンインストール後はTUNモードなどの高度な機能が使用できなくなります。',
      uninstallConfirmButton: 'アンインストールを確認',
      cancelButton: 'キャンセル',
    },
  },
}
