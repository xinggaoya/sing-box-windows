export default {
  ...
  home: {
    ...
    escalatePrivileges: '権限昇格',
    proxyModeSelector: 'プロキシモード',
    nodeModeSelector: 'ノードモード',
    trafficMonitor: 'トラフィック監視',
    adminStatus: {
      admin: '管理者',
      normal: '一般ユーザー',
    },
  ...
  setting: {
    ...
    update: {
      title: '更新設定',
      subtitle: 'アプリケーション更新とバージョンチェックオプションの設定',
      check: 'アップデート確認',
      autoCheck: '自動更新チェック',
      autoCheckDesc: '起動時に自動でアプリケーション更新をチェック',
      acceptPrerelease: 'テストバージョンを受信',
      acceptPrereleaseDesc: 'プレリリース版（テストバージョン）の受信とインストールを許可',
      current: '現在のバージョン',
      newVersion: '新しいバージョン',
      ...
      beta: 'テストバージョン',
      prereleaseWarning: 'テストバージョン警告',
      prereleaseWarningDesc:
        'テストバージョンには不安定な機能や潜在的な問題が含まれる可能性があります。テスト環境でのみ使用することをお勧めします。',
      prereleaseConfirm: 'テストバージョンの有効化を確認',
      prereleaseConfirmDesc:
        '有効にすると、プレリリース版の更新通知を受信します。これらのバージョンは不安定な可能性がありますが、続行しますか？',
      prereleaseEnabled: 'テストバージョンが有効になりました',
      prereleaseEnabledDesc: 'プレリリース版の更新通知を受信します',
      prereleaseDisabled: 'テストバージョンが無効になりました',
      prereleaseDisabledDesc: '正式版の更新通知のみを受信します',
    },
    autoStart: {
      title: '自動開始',
      app: 'システム起動時に開始',
  ...
  rules: {
    ...
    fetchTimeout: 'ルール取得タイムアウト、カーネルが正常に動作しているか確認してください',
    totalRules: '総ルール数',
  ...
  notification: {
    ...
    prereleaseUpdateAvailable: '新しいテストバージョンが利用可能です',
    testVersionAvailable: '新しいテストバージョンが利用可能です',
    newTestVersion: '新しいテストバージョン: {version}',
    ...
    prereleaseAvailable: '新しいテストバージョンが利用可能です',
    autoStartFailed: 'カーネル自動起動失敗、手動起動するか設定を確認してください',
    kernelProcessRunning: 'カーネルプロセスが既に実行中ですが、再接続が必要な可能性があります',
  },
}
