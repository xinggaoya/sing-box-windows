export default {
  ...
  notification: {
    ...
    kernelErrors: {
      ...
      KERNEL_BINARY_MISSING: 'カーネルファイルが見つかりません。先にカーネルをインストールしてください。',
      KERNEL_START_UNSTABLE: 'カーネルが起動直後に終了しました。設定やポートの使用状況を確認してください。',
      ...
      KERNEL_CONFLICT_FORCE_STOP_FAILED: '旧カーネルプロセスの強制停止に失敗しました。手動でプロセスを終了して再試行してください。',
