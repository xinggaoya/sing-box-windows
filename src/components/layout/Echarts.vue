...
// 监听上传和下载速度的变化，更新图表数据
watch([() => props.uploadSpeed, () => props.downloadSpeed], ([newUploadSpeed, newDownloadSpeed]) => {
  // 将传入的毫秒值转换为 MB/s
  const mbUploadSpeed = newUploadSpeed / 1024 / 1024 / 1024
  const mbDownloadSpeed = newDownloadSpeed / 1024 / 1024 / 1024
