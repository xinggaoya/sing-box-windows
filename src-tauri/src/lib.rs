...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::app::core::proxy_service::get_clash_mode_status,
            crate::app::core::proxy_service::set_clash_mode,
            crate::app::core::proxy_service::set_group_expand,
            crate::app::core::proxy_service::get_started_at,
            ...
            // Core - Proxy service commands（inbound 写入 + 自定义规则）
